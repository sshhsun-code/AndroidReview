...
import com.review.sunqi.iamss.androidreview.AndroidReviewApp;
...
class IActivityManagerHandler implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        if ("startActivity".equals(method.getName())) {
            ...
            String stubPackage = AndroidReviewApp.getContext().getPackageName();

            // 这里我们把启动的Activity临时替换为 MySubActivity
            ComponentName componentName = new ComponentName(stubPackage, MySubActivity.class.getName());
